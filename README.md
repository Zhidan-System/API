# Zhidan OpenAPI Specification
[![Build Status](https://travis-ci.org/https://zhidan-system.github.io/API.svg?branch=master)](https://travis-ci.org/https://zhidan-system.github.io/API)
...
6. If you did everything correct, https://https:.github.io// will lead to your new docs
...
- Documentation(ReDoc): https://https:.github.io//
- SwaggerUI: https://https:.github.io//swagger-ui/
- Look full spec:
    + JSON https://https:.github.io//swagger.json
    + YAML https://https:.github.io//swagger.yaml
- Preview spec version for branch `[branch]`: https://https:.github.io//preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://https:.github.io// with url from the message: `Server started <url>`
